...
%     simul.healthy_t(:,1)=simul.healthy_t(:,1)+(simul.hstate(:,t)==1);
%      simul.medcost(:,t)=...
%          (simul.hstate(:,t)==2)*(simul.sick_dec(:,t))*simul.M(t,2)/simul.rfactor(t,1)+...
%          (simul.hstate(:,t)==3)*(simul.sick_dec(:,t))*simul.M(t,3)/simul.rfactor(t,1)+...
%          (simul.hstate(:,t)==4)*(simul.sick_dec(:,t))*simul.M(t,4)/simul.rfactor(t,1);
%     simul.benefit_all(:,t)=...
%         (simul.hstate(:,t)==2).*(simul.sick_t(:,1)<=simul.T)*simul.B(t,2)/simul.rfactor(t,1)+...
%         (simul.hstate(:,t)==3).*(simul.sick_t(:,1)<=simul.T)*simul.B(t,3)/simul.rfactor(t,1)+...
%         (simul.hstate(:,t)==4).*(simul.sick_t(:,1)<=simul.T)*simul.B(t,4)/simul.rfactor(t,1);
%     simul.premium_all(:,t)=...
%         (simul.hstate(:,t)==1).*(simul.healthy_t(:,1)<=simul.T).*simul.P(t,1)/simul.rfactor(t,1);  
