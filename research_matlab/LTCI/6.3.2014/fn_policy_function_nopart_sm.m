function [optism optixm optivm]=fn_policy_function_nodefer_sm(para,LTCI)
...
for t=para.T:-1:1;
    ...
    if t<para.T;
        ...
        EV_healthy_healthy=interp1(optism.a(:,1),optivm.healthy(:,t+1),sprime_asset_healthy,'linear','extrap');
        EV_healthy_hc=interp1(optism.a(:,1),optivm.hc(:,t+1),sprime_asset_healthy,'linear','extrap');        
        EV_healthy_alf=interp1(optism.a(:,1),optivm.alf(:,t+1),sprime_asset_healthy,'linear','extrap');        
        EV_healthy_nh=interp1(optism.a(:,1),optivm.nh(:,t+1),sprime_asset_healthy,'linear','extrap');
        EV_hc_healthy=interp1(optism.a(:,1),optivm.healthy(:,t+1),sprime_asset_hc,'linear','extrap');
        EV_hc_hc=interp1(optism.a(:,1),optivm.hc(:,t+1),sprime_asset_hc,'linear','extrap');
        EV_hc_alf=interp1(optism.a(:,1),optivm.alf(:,t+1),sprime_asset_hc,'linear','extrap');
        EV_hc_nh=interp1(optism.a(:,1),optivm.nh(:,t+1),sprime_asset_hc,'linear','extrap');
        EV_alf_healthy=interp1(optism.a(:,1),optivm.healthy(:,t+1),sprime_asset_alf,'linear','extrap');
        EV_alf_hc=interp1(optism.a(:,1),optivm.hc(:,t+1),sprime_asset_alf,'linear','extrap');        
        EV_alf_alf=interp1(optism.a(:,1),optivm.alf(:,t+1),sprime_asset_alf,'linear','extrap');        
        EV_alf_nh=interp1(optism.a(:,1),optivm.nh(:,t+1),sprime_asset_alf,'linear','extrap');        
        EV_nh_healthy=interp1(optism.a(:,1),optivm.healthy(:,t+1),sprime_asset_nh,'linear','extrap');
        EV_nh_hc=interp1(optism.a(:,1),optivm.hc(:,t+1),sprime_asset_nh,'linear','extrap');        
        EV_nh_alf=interp1(optism.a(:,1),optivm.alf(:,t+1),sprime_asset_nh,'linear','extrap');        
        EV_nh_nh=interp1(optism.a(:,1),optivm.nh(:,t+1),sprime_asset_nh,'linear','extrap'); 
