function [optism optixm optivm]=fn_policy_function_deductible_sm(para,LTCI)
...
for t=para.T:-1:1;
    ...
    if t<para.T;
        ...
        EV_healthy_healthy=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.healthy(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_healthy,sprime_medcost_nominal_healthy,sprime_protect_healthy,'linear');
        EV_healthy_hc=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.hc(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_healthy,sprime_medcost_nominal_healthy,sprime_protect_healthy,'linear');        
        EV_healthy_alf=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.alf(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_healthy,sprime_medcost_nominal_healthy,sprime_protect_healthy,'linear');        
        EV_healthy_nh=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.nh(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_healthy,sprime_medcost_nominal_healthy,sprime_protect_healthy,'linear');
        EV_hc_healthy=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.healthy(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_hc,sprime_medcost_nominal_hc,sprime_protect_hc,'linear');
        EV_hc_hc=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.hc(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_hc,sprime_medcost_nominal_hc,sprime_protect_hc,'linear');
        EV_hc_alf=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.alf(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_hc,sprime_medcost_nominal_hc,sprime_protect_hc,'linear');
        EV_hc_nh=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.nh(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_hc,sprime_medcost_nominal_hc,sprime_protect_hc,'linear');
        EV_alf_healthy=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.healthy(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_alf,sprime_medcost_nominal_alf,sprime_protect_alf,'linear');
        EV_alf_hc=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.hc(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_alf,sprime_medcost_nominal_alf,sprime_protect_alf,'linear');        
        EV_alf_alf=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.alf(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_alf,sprime_medcost_nominal_alf,sprime_protect_alf,'linear');        
        EV_alf_nh=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.nh(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_alf,sprime_medcost_nominal_alf,sprime_protect_alf,'linear');        
        EV_nh_healthy=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.healthy(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_nh,sprime_medcost_nominal_nh,sprime_protect_nh,'linear');
        EV_nh_hc=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.hc(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_nh,sprime_medcost_nominal_nh,sprime_protect_nh,'linear');        
        EV_nh_alf=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.alf(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_nh,sprime_medcost_nominal_nh,sprime_protect_nh,'linear');        
        EV_nh_nh=interpn(s_asset,s_medcost_nominal,s_protect,reshape(optivm.nh(:,t+1),para.grid_asset,para.grid_medcost_nominal,para.grid_protect),sprime_asset_nh,sprime_medcost_nominal_nh,sprime_protect_nh,'linear'); 
